                    ...
                    <form class="form-horizontal form-label-left" action="{{route('CMS.news.create_post')}}" method="post" enctype="multipart/form-data">
                       {{csrf_field()}}
                        <div class="form-group">
                            <h2>New Image</h2>
                            <div class="col-sm-12">
                                <input type="file"   name="img_url" class="btn btn-default btn-sm" title="Upload New Image">
                            </div>
                        </div>
                        <div class="form-group">
                            <h2>New Title</h2>
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <button onclick="return confirm('Yeni Kayıt eklensin mi?')" type="submit" class="btn btn-success">Save</button>
                            </div>
                        </div>
                    </form>
                </div>
