                            ...
                            @foreach ($news as $new)
                                <tr>
                                    ...
                                    <td style="width: 15%">
                                        ...
                                        <a onclick="return confirm('Silmek istediğinize emin misiniz?')" href="{{route('CMS.news.remove', $new->id )}}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete
                                        </a>
                                    </td>
                                </tr>
                                @php $i=$i+1 @endphp
