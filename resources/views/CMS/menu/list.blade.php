                    ...
                    <div class="x_content">
                        ...
                        <table class="table table-striped projects">
                            ...
                            <tr>
                                ...
                                <td style="width: 15%">
                                    <a
                                        href="{{route('CMS.menu.edit',$menu->id)}}" class="btn btn-info btn-xs">
                                        <i class="fa fa-pencil"></i> Edit </a>

                                    <a onclick="return confirm('Menünün submenüleri de silinecektir. Silmek istediğinize emin misiniz?')"
                                       href="{{route('CMS.menu.remove',$menu->id)}}"
                            ...
                            <tr>
                                ...
                                <td style="width: 15%">
                                    <a
                                        href="{{route('CMS.menu.editsubs',$subs->id)}}"
                                        class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>

                                    <a onclick="return confirm('SubMenu silinsin mi?')"
                                       href="{{route('CMS.menu.remove_subs',$subs->id)}}"
                                       class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                                </td>
                            </tr>
                                @php $x=$x+1 @endphp
